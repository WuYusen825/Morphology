...
import coding
KW={'戔':'小|少|淺|薄|微','侖':'理|倫|次|序|條','農':'厚|濃|多','句':'曲|句|鉤|拘','皮':'分|析|剝|破|離|裂|碎','兼':'并|幷|兼|兩|二','巠':'直|長|莖','叚':'赤|紅|丹','冓':'交|遇|會|合','堯':'高','喬':'高|長','氐':'下|底|根|至|抵','票':'輕|飛|浮|疾|末|風','叕':'連|聯|綴|續|合','青':'清|明|精|潔|純'}
...
for s,kw in KW.items():
    ...
    out.append(dict(series=s,keywords=kw,n_members=len(mem),kw_hits=a,kw_rate=round(a/len(mem),3),baseline_rate=round(c/len(others),3),
